...
import { addTodo, editTodo, clear } from '../action/todoActions'
...
class AddTodo extends Component {
    ...
    render() {
        return (
            <div className ="todo">
                <input className="input" value={this.state.text} onChange={this.handleChange} type="text" placeholder="add new todo" />
                <button className="btnn" onClick={this.addNewTodo}>
